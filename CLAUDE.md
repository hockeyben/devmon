...
This project does NOT use the GSD workflow (user decision, 2026-07-08). Edit
files directly; ignore GSD workflow advisories from global hooks. The
`.planning/` directory is retained as historical record only — do not update
STATE.md or create GSD planning artifacts for new work.
