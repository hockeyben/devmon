...
def test_gamestate_schema_version_default_is_9():
    """Test 4a: GameState schema_version default is 9 (Phase 9 bump)."""
...
def test_full_migration_chain_0_to_7():
    """Test 8: Full migration chain 0->8 produces valid data."""
...
def test_current_version_invariant():
    """Test 9: CURRENT_VERSION == 9 == GameState().schema_version (invariant from Phase 1)."""
