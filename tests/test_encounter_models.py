...
def test_gamestate_schema_version_default_is_12():
...
def test_full_migration_chain_0_to_12():
    """Test 8: Full migration chain 0->12 produces valid data."""
...
def test_all_creature_jsons_load_with_allowed_rarities():
    """Test 10: All 78 creature JSON files load successfully with allowed_rarities field present (27 -> 75 Phase B1, +3 mythics Phase E)."""
    ...
    assert len(creatures_dict) == 78, f"Expected 78 creatures, got {len(creatures_dict)}"
