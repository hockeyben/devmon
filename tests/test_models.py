...
def test_schema_version_is_9():
    """TRACK-01: GameState.schema_version defaults to 9 after Phase 9 bump."""
    state = GameState.new_game("Ash")
    assert state.schema_version == 9
...
def test_full_migration_chain_v0_to_v9():
    """Schema migration: v0 data migrates cleanly to v9 producing valid GameState."""
    from devmon.persistence.migrations import migrate
