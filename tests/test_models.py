...
def test_schema_version_is_8():
    """TRACK-01: GameState.schema_version defaults to 8 after Phase 8 bump."""
    state = GameState.new_game("Ash")
    assert state.schema_version == 8
...
def test_full_migration_chain_v0_to_v8():
    """Schema migration: v0 data migrates cleanly to v8 producing valid GameState."""
    from devmon.persistence.migrations import migrate
